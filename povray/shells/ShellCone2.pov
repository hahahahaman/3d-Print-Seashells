// -w240 -h180 +a0.3
camera { location  <0, 6, -20> look_at <-0.2, -4, 0> angle 30}
...
#declare A=-0.3; // Angle of tilt of cross section (radians)
#declare S=3.0;  // Stretch
...
#declare Fz = function(u,v){S*W(u)*(sin(v+A)+cos(2*v+A)*T/4)  + S*H*pow(u/(2*pi),P)}
